...
namespace BookingSystem.Controllers
{
	public class RoomController : BaseApiController
	{
		...
		public async Task<IActionResult> GetRooms(int id, DateTime? checkIn, DateTime? checkOut)
		{
			return Ok(_roomService.GetRoomsByGuestHouseId(id, checkIn, checkOut).Result);
		}
